...
export default function PopularRecipesScreen() { // Main component for popular recipes screen
  ...
  const loadRecipes = async () => {
    ...
    const newRecipes = await fetchPopularRecipes(offset); // Fetch new recipes using the current offset
