      ...
      <SafeAreaView>
        <View style={styles.backButtonContainer}>
          <TouchableOpacity
            ...
            style={styles.backButton} // Separate styling for back button
          >
        ...
        <View style={{ padding: 16 }}>
          ...
          {recipes.map((item, index) => ( // Iterates over the list of recipes to display each one
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate("Recipe", { id: item.id })} // Navigates to the detailed recipe screen with relevant recipe's ID
